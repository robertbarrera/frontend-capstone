...
const Specials = () => {
    const foods = [
        ...
        {id: 2, type:"specials", image: "/bruchetta.svg", description: "Our Bruschetta is made from grilled bread that has been smeared with garlic and seasoned with salt and olive oil, and topped with flavorful locally grown tomatoes", 
            title: "Bruschetta", price: "$ 5.99" },
        {id: 3, type:"specials", image: "/bistroSandwich.png", description: "A light and refreshing sandwich centered around a healthy serving of locally sourced turkey, topped with carmelized onions, and wrapped in a fluffy brioche bun.",
            ...
            <section className="foods grid">
                {foods.map(food => (
                    <article key={food.id} className="bg">
                        ...
                        />
                        <p><strong>Order a dekivery</strong></p>
                    </article>
                ))}
            </section>
        </section>
